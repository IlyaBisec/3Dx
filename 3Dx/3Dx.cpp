// Entry point to the 3dx program 11
...
//
//void SetupWorldMatrix(float rotationAngle, XMMATRIX &worldMatrix);
//void Render(ID3D11DeviceContext *deviceContext, ID3D11Buffer *constantBuffer, float rotationAngle);
...
//    wc.lpszClassName = L"3DxEditorClass";
//
//    RegisterClassEx(&wc);
//
...
//    SetupWorldMatrix(rotationAngle, worldMatrix);
//
//    // Обновление буфера констант
...
//
//    // Отрисовка объекта
//    deviceContext->DrawIndexed(3,0,1);
//}