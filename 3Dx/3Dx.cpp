...

{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_3DX_EDITOR));
...
ATOM register_class(HINSTANCE hInstance)
{
    LoadStringW(hInstance, IDC_3DX_EDITOR, szWindowClass, MAX_LOADSTRING);
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_3DX_EDITOR));
    //alternative syntax :
    ...
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_3DX_EDITOR);
